  ...
  render(){
    ...
    return (
      <div>
         <CardText>
          <p>
            The End-User License Agreement (this "EULA") is a legal agreement between you ("Licenssee") and Symptomatic, LLC ("Licensor"), the author of Symptomatic Timeline and Continuity of Care Document Viewer ("Timeline").
            {/* Continuity of Care Document Generator, including all HTML files, Javascript files, graphics, animations, data, technology, development tools, scripts and programs, both in object code and source code (the "Software"), the deliverables provided pursuant to this EULA, which may include associated media, printed materials, and "online" or electronic documentation.                 */}
          </p>
          <p>
