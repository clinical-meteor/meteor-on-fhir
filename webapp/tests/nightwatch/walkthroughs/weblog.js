...
module.exports = {
  ...
  "user can navigate to weblog page" : function (client) {
    client
      .click("#weblogLink").pause(500)
      .verify.elementPresent("#weblogPage")
      .saveScreenshot("tests/nightwatch/screenshots/iTunesConnect/A-weblogPage.png")
  },

  "user should be able to log status" : function (client) {
    client
      .verify.elementPresent("#statusInputCard")
      .verify.elementPresent("#statusTitleInput")
      .verify.elementPresent("#statusTextInput")
      .verify.elementPresent("#statusImageUrlInput")
      .verify.elementPresent("#labelInput")
      
      .clearValue("#statusTitleInput")
      .clearValue("#statusTextInput")
      .clearValue("#statusImageUrlInput")
      .clearValue("#labelInput")
      
      .setValue("#statusTitleInput", "Foo")
      .setValue("#statusTextInput", "Lorem ipsum...")
      .setValue("#statusImageUrlInput", "http://www.somewhere.com/foo.jpg")
      .setValue("#labelInput", "foo")
  },
  
  "status should have title, text, image, and labels" : function (client) {
    client
      .verify.elementPresent("#statusList")
