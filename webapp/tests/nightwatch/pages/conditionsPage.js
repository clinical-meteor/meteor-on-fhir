  ...
  commands: [{
    ...
    verifyConditionListCard: function() {
      return this
        ...
        .verify.elementPresent('#conditionsTable .conditionRow:nth-child(1) .patientDisplay')
        .verify.elementPresent('#conditionsTable .conditionRow:nth-child(1) .asserterDisplay')
        ...
        .verify.elementPresent('#conditionsTable .conditionRow:nth-child(1) .evidenceDisplay');
    },
    selectNewConditionTab: function() {
      return this
        .verify.elementPresent('#conditionsPageTabs')
        .verify.elementPresent('#conditionsPageTabs .newConditionTab')
        .click("#conditionsPageTabs .newConditionTab");
    },
    verifyNewConditionCard: function() {
      return this
        .verify.elementPresent('#conditionsPage .conditionDetail')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="patientDisplay"]')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="asserterDisplay"]')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="clinicalStatus"]')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="snomedCode"]')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="snomedDisplay"]')
        .verify.elementPresent('#conditionsPage .conditionDetail input[name="evidenceDisplay"]');
    },
    ...
    selectListTab: function(){
      return this.click('#conditionsPage .conditionListTab');
    },
    displayListCard: function(){
      return this.click('#conditionsPage .conditionListTab');
    },
    displayNewConditionCard: function(){
      return this.click('#conditionsPage .newConditionTab');
    },
    displayConditionDetails: function(){
      return this.click('#conditionsPage .conditionDetailsTab');
    },
