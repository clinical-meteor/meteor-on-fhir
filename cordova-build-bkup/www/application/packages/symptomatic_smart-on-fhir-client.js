...
var Patient = Package['clinical:hl7-resource-patient'].Patient;
var Patients = Package['clinical:hl7-resource-patient'].Patients;
var PatientSchema = Package['clinical:hl7-resource-patient'].PatientSchema;
var Observation = Package['clinical:hl7-resource-observation'].Observation;
var Observations = Package['clinical:hl7-resource-observation'].Observations;
var ObservationSchema = Package['clinical:hl7-resource-observation'].ObservationSchema;
var CarePlan = Package['clinical:hl7-resource-careplan'].CarePlan;
var CarePlans = Package['clinical:hl7-resource-careplan'].CarePlans;
var CarePlanSchema = Package['clinical:hl7-resource-careplan'].CarePlanSchema;
...
var User = Package['clinical:user-model'].User;
var UserIdExtension = Package['clinical:user-model'].UserIdExtension;
...
var require = meteorInstall({"node_modules":{"meteor":{"symptomatic:smart-on-fhir-client":{"client":{"OAuth.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/client/OAuth.js                                                           //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var get;
...
var OAuth;
module.link("meteor/clinical:oauth", {
  OAuth: function (v) {
    OAuth = v;
  }
}, 1);
...
module.exportDefault(OAuth.requestCredential = function (options, credentialRequestCompleteCallback, serviceName) {
  console.log("********************************************");
  ...
  if (!config) {
    credentialRequestCompleteCallback && credentialRequestCompleteCallback(ServiceConfiguration.ConfigError('Service not configured'));
  } else {
    if (!config.baseUrl) {
      credentialRequestCompleteCallback && credentialRequestCompleteCallback(ServiceConfiguration.ConfigError('Service found but it does not have a baseUrl configured.'));
    }

    if (!config.loginUrl) {
      credentialRequestCompleteCallback && credentialRequestCompleteCallback(ServiceConfiguration.ConfigError('Service found but it does not have a loginUrl configured.'));
    }
    ...
    var credentialToken = Random.secret(); //var credentialToken = '2e80e475-5930-48f3-968e-de4429f09572';
    // always need this to get user id from service.
    // TODO: if(serviceName === "Epic")

    var requiredScope = ['email', 'OBSERVATION.READ', 'OBSERVATION.SEARCH', 'PATIENT.READ', 'PATIENT.SEARCH', 'PRACTITIONER.READ', 'PRACTITIONER.SEARCH', 'patient/*.read', 'patient/*.search', 'openid'];
    var scope = ['OBSERVATION.READ', 'OBSERVATION.SEARCH', 'PATIENT.READ', 'PATIENT.SEARCH', 'PRACTITIONER.READ', 'PRACTITIONER.SEARCH', 'patient/*.read', 'patient/*.search', 'openid', 'email', 'profile', 'user/*.*', 'launch', 'online_access'];
    ...
    var loginUrl = config.loginUrl + '?response_type=code' + '&client_id=' + config.clientId + '&redirect_uri=' + OAuth._redirectUri(serviceName, config) + '&state=' + OAuth._stateParam(loginStyle, credentialToken);
    ...
    if (serviceName === "Omnibus") {
      ...
      + '&launch=' + Session.get('ehrLaunchContext') + '&scope=user%2FPatient.read%20' + 'user%2FEncounter.read%20' + 'user%2FPerson.read%20' + 'patient%2FPractitioner.read%20' + 'launch%2Fpatient%20' + 'online_access%20' + 'openid%20' + 'profile%20' + 'user%2FPatient.read%20' + 'patient%2FDocumentReference.read%20' + 'user%2FObservation.write%20' + 'lauch%2Forganization%20' + 'user%2FObservation.read%20' + 'patient%2FPatient.read%20' + 'user%2FDocumentReference%20' + 'patient%2FPerson%20' + 'patient%2FObservation.read%20' + 'patient%2FEncounter.read%20' + 'patient%2FDocumentReference.write%20' + 'user%2FDocumentReference.read%20' + 'patient%2FObservation.write%20';
    }

    if (serviceName === "CernerPatient") {
      console.log('Detected the CernerPatient service...');
      loginUrl = loginUrl + '&aud=' + config.baseUrl + '&scope=user%2FPatient.read%20' + 'user%2FAllergyIntolerance.read%20' + 'user%2FCarePlan.read%20' + 'user%2FCondition.read%20' + 'user%2FDevice.read%20' + 'user%2FGoal.read%20' + 'user%2FImmunization.read%20' + 'user%2FMedication.read%20' + 'user%2FMedicationStatement.read%20' + 'user%2FPatient.read%20' + 'user%2FPractitioner.read%20' + 'user%2FProcedure.read%20' + 'user%2FOrganization.read%20' + 'user%2FObservation.read';
    }

    if (serviceName === "CernerProvider") {
      console.log('Detected the CernerProvider service...');
      loginUrl = loginUrl + '&aud=' + config.baseUrl + '&launch=' + Session.get('ehrLaunchContext') + '&scope=user%2FPatient.read%20' + 'user%2FAllergyIntolerance.read%20' + 'user%2FCarePlan.read%20' + 'user%2FCondition.read%20' + 'user%2FDevice.read%20' + 'user%2FGoal.read%20' + 'user%2FImmunization.read%20' + 'user%2FMedication.read%20' + 'user%2FMedicationStatement.read%20' + 'user%2FPatient.read%20' + 'user%2FPractitioner.read%20' + 'user%2FProcedure.read%20' + 'user%2FOrganization.read%20' + 'user%2FObservation.read';
    }

    if (serviceName === "Allscripts") {
      console.log('Detected the AllScripts service...');
      loginUrl = loginUrl + '&scope=launch%20openid%20profile%20patient%2F*.read%20' + '&acr_values=FhirApiID:6dc1c200-b14f-407f-9d98-4ea8c3f5627f';
    }

    if (serviceName === "Touchworks") {
      console.log('Detected the AllScripts Touchworks service...');
      loginUrl = loginUrl + '&scope=launch%20openid%20profile%20patient%2F*.read%20' + '&acr_values=FhirApiID:e9a5eab3-b766-4b86-a0d2-8634311fce2c';
    }

    if (['DynamicFhir', 'DynamicHealth'].includes(serviceName)) {
      console.log('Detected the DynamicFhir service...');
      loginUrl = loginUrl + '&scope=offline_access%20FHIRApi%20openid%20profile%20patient%2F*.read' // probably want to remove this in the future and change the secret
      // but for now, policy is that we don't support secrets
      // so, we just hardcode itß
      // DynamicHealth
      // might need to urlEncode the redirect
      // + '&grant_type=authorization_code'
      + '&client_secret=3B79E5D274954B7EA97C';
    }
...
},"AdminConfigPage.jsx":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/client/AdminConfigPage.jsx                                                //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
...
var CardHeader, CardText, CardTitle, CardActions, TextField, Toggle, Paper, FlatButton, RaisedButton;
...
var PatientDetail, PatientTable, PatientCard;
module.link("meteor/clinical:hl7-resource-patient", {
  PatientDetail: function (v) {
    PatientDetail = v;
  },
  PatientTable: function (v) {
    PatientTable = v;
  },
...
function (_React$Component) {
  (0, _inheritsLoose2.default)(AdminConfigPage, _React$Component);

  function AdminConfigPage(props) {
    var _this;

    _this = _React$Component.call(this, props) || this;
    _this.state = defaultOAuthState;
    return _this;
  }

  var _proto = AdminConfigPage.prototype;
  ...
  _proto.getMeteorData = function () {
    function getMeteorData() {
      ...
      data.state.userData = EJSON.stringify(getUserData.get(), {
        indent: 2
      });
      data.state.patientData = EJSON.stringify(getPatientData.get(), {
        indent: 2
      });
      return data;
    }
  ...
  _proto.render = function () {
    function render() {
      ...
      var path = "_oauth/" + this.state.formData.serviceName;
      var oAuthPath = baseUrl + path;
      var serviceName = this.state.formData.serviceName;
      ...
      for (var i = 0; i < this.data.services.length; i++) {
        ...
        }, this.data.services[i].service), React.createElement("td", {
          className: "clientId",
          style: this.data.style.cell
        }, this.data.services[i].clientId), React.createElement("td", {
          className: "secret",
          style: this.data.style.cell
        }, this.data.services[i].secret), React.createElement("td", {
          className: "baseUrl",
          style: this.data.style.cell
        }, this.data.services[i].baseUrl, React.createElement("br", null), this.data.services[i].loginUrl), React.createElement("td", {
          className: "removeBtn",
          style: this.data.style.cell
      ...
      for (var j = 0; j < this.data.services.length; j++) {
        signInWiths.push(React.createElement("div", {
          key: j
      ...
      return React.createElement("div", {
      ...
      }, this.state.metadata))))), React.createElement(CardActions, null, React.createElement(FlatButton, {
        label: "Autoscan",
        id: "autoscanButton",
      ...
      }), React.createElement(CardText, null, React.createElement("p", null, "If you operate the AuthenticationServer, you can add a client by directly editing it's database.  In a production environment, this entry would be generated by an admin console or a client API KeyRequestPage."), React.createElement("p", null, "If you do not operate the resource owner, then you must contact the service in some way to get the keys.  This step may require business agreements, online registration, agreement to terms and services, license or subscription fees, service level agreements, background checks, insurance policies, security audits, and other technical due diligence."), React.createElement("p", null, "When ready, the AuthenticationServer will need the following Redirect URI.  This URI is environment specific.  If you deploy to staging, testing, production, etc. you will need to update this URI on the Authorization Server, or you will need to create a second app."), React.createElement("h3", {
        style: {
          width: '100%',
          textAlign: 'center'
        }
      }, oAuthPath))), React.createElement(DynamicSpacer, null), React.createElement(GlassCard, {
        width: "768px",
        zDepth: 2
      }, React.createElement(CardTitle, {
        title: "4.  Configure This Application",
        subtitle: React.createElement("a", {
          href: "https://github.com/meteor/meteor/wiki/OAuth-for-mobile-Meteor-clients#loginStyle-vepopuprsus-redirect-flow"
        ...
        fullWidth: true
      }), React.createElement("br", null), React.createElement("br", null), React.createElement(Toggle, {
        label: "loginStyle",
        ref: "loginStyle",
        name: "loginStyle",
        labelPosition: "right",
      ...
      }), React.createElement(CardText, null, React.createElement(Table, null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {
        className: "service",
        style: {
          minWidth: '100px'
        }
      ...
      }, "clientId"), React.createElement("th", {
        className: "secret",
        style: {
          minWidth: '100px'
        }
      }, "secret"), React.createElement("th", {
        className: "baseUrl",
        style: {
          minWidth: '100px'
        }
      }, "baseUrl"), React.createElement("th", {
        className: "remove",
        style: {
          minWidth: '100px'
        }
      }, "remove"))), React.createElement("tbody", null, tableRows))), React.createElement(CardActions, null, React.createElement(FlatButton, {
  ...
  _proto.editServiceName = function () {
    function editServiceName(field, event, value) {
  ...
  _proto.editclientId = function () {
    function editclientId(field, event, value) {
      //console.log('editclientId', value)
      var newFormData = this.state.formData;
  ...
  _proto.editSecretKey = function () {
    function editSecretKey(field, event, value) {
    ...
    return editSecretKey;
  }();

  _proto.editTargetBaseUrl = function () {
    function editTargetBaseUrl(field, event, value) {
    ...
    return editTargetBaseUrl;
  }();

  _proto.editTargetLoginUrl = function () {
    function editTargetLoginUrl(field, event, value) {
    ...
    return editTargetLoginUrl;
  }();

  _proto.editloginStyle = function () {
    function editloginStyle(fipopupeld, event, value) {
    ...
    return editloginStyle;
  }();

  _proto.updateSearch = function () {
    function updateSearch(field, event, value) {
  ...
  _proto.updateBaseUrl = function () {
    function updateBaseUrl(event, value) {
  ...
  _proto.autoscan = function () {
    function autoscan() {
      console.log('autoscan');
      var self = this;
      var metadataRoute = this.state.baseUrl + '/metadata' + formatSuffix;
      console.log('metadata route', metadataRoute); //   HTTP.get(metadataRoute, { headers: {
      ...
      Meteor.call('metadataAutoscan', this.state.baseUrl, function (error, result) {
        ...
        if (result) {
          ...
          self.setState({
            metadata: EJSON.stringify(capabilityStatement, {
              indent: 2
            }),
  ...
  _proto.clearAutoscan = function () {
    ...
    return clearAutoscan;
  }();

  _proto.extractAutoconfigValues = function () {
    function extractAutoconfigValues() {
    ...
    return extractAutoconfigValues;
  }();

  _proto.saveConfiguration = function () {
  ...
  _proto.signInWith = function () {
    function signInWith(serviceName) {
  ...
  _proto.resyncConfiguration = function () {
    function resyncConfiguration() {
      console.log('C2.  Resyncing Configuration');
      Meteor.call('resyncConfiguration');
    }

    return resyncConfiguration;
  }();

  _proto.removeEntry = function () {
    function removeEntry(_id) {
      check(_id, String);

      if (confirm('Remove configuration?')) {
        console.log('removing...', _id); //ServiceConfiguration.configurations.remove({_id: _id});
...
module.exportDefault(AdminConfigPage);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"FastImportPage.jsx":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/client/FastImportPage.jsx                                                 //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");
...
module.export({
  FastImportPage: function () {
    return FastImportPage;
  }
});
var React;
module.link("react", {
...
var CardText, CardTitle, CardActions, TextField, FlatButton, RaisedButton;
module.link("material-ui", {
  CardText: function (v) {
    CardText = v;
  },
...
var Table, TableBody, TableRow, TableRowColumn;
...
/*#__PURE__*/
function (_React$Component) {
  (0, _inheritsLoose2.default)(FastImportPage, _React$Component);

  function FastImportPage(props) {
    var _this;
  ...
  var _proto = FastImportPage.prototype;
  ...
  _proto.getMeteorData = function () {
    function getMeteorData() {
      ...
      process.env.TRACE && console.log('FastImportPage.data', data); // process.env.TRACE && console.log('FastImportPage.props')
  ...
  _proto.render = function () {
    function render() {
      ...
      var dataManagementButtons = []; // systemSyncButtons.push(<FlatButton 
      ...
      systemSyncButtons.push(React.createElement(FlatButton, {
        label: "Diagnostics",
        key: "diag",
      ...
      dataManagementButtons.push(React.createElement(FlatButton, {
        key: "identity",
      ...
      if (get(this, 'data.minimongo.MedicationOrders')) {
        ...
        }, React.createElement(TableRowColumn, null, this.data.minimongo.MedicationOrders), React.createElement(TableRowColumn, null, "Medication Orders")));
      }
      ...
      var continuityOfCareCard = React.createElement("div", null, React.createElement(GlassCard, null, React.createElement(CardTitle, {
      ...
      }, "Resource")), ccdResources)))), React.createElement(DynamicSpacer, null));
      return React.createElement("div", {
        id: "FastImportPage"
      }, React.createElement(VerticalCanvas, null, React.createElement(Grid, null, React.createElement(Row, null, React.createElement(Col, {
        md: 3
      }, React.createElement(DynamicSpacer, null), React.createElement(GlassCard, {
        zDepth: 2
      }, React.createElement(CardText, null, systemSyncButtons, React.createElement("br", null), signInWiths, React.createElement("br", null), dataManagementButtons, React.createElement("br", null))), React.createElement(DynamicSpacer, null), React.createElement("h3", {
        className: "barcode",
        style: {
          width: '100%',
          textAlign: 'center',
      ...
      }, this.state.accessToken)), React.createElement(Col, {
        mdOffset: 1,
        md: 8
      }, React.createElement(DynamicSpacer, null), React.createElement(PatientCard, {
        patient: this.state.patient,
        zDepth: 2
      }), continuityOfCareCard, React.createElement(GlassCard, null, React.createElement(RaisedButton, {
  ...
  _proto.timelineVisualization = function () {
  ...
  _proto.selectPatientCallback = function () {
    function selectPatientCallback(patientId) {
  ...
  _proto.resetServiceConfiguration = function () {
    function resetServiceConfiguration() {
      console.log('resetServiceConfiguration');
    }

    return resetServiceConfiguration;
  }();

  _proto.simulateLaunchContext = function () {
    function simulateLaunchContext() {
      console.log('simulateLaunchContext');
    }

    return simulateLaunchContext;
  }();

  _proto.fetchAccessToken = function () {
  ...
  _proto.fetchPatientData = function () {
    function fetchPatientData() {
      ...
      HTTP.get(fetchUrl, {
        ...
        if (result) {
          ...
          var newState = self.state;
          newState.patientData = EJSON.stringify(patientData, {
            indent: 2
          });
  ...
  _proto.savePatientDemographicsToProfile = function () {
    function savePatientDemographicsToProfile() {
      ...
      if (get(this, 'state.patient')) {
        var newPatient = this.state.patient; // STU3 HumanName mapping
    ...
    return savePatientDemographicsToProfile;
  ...
  _proto.runDiagnostics = function () {
        ...
        resourceTypes.forEach(function (resourceType) {
          if (Mongo.Collection.get(resourceType)) {
            Mongo.Collection.get(resourceType).find().forEach(function (record) {
              Mongo.Collection.get(resourceType)._collection.remove({
                _id: record._id
              });
            });
          }
  ...
  _proto.searchChart = function () {
    function searchChart() {
      console.log('Asking server to fetch patient chart for us...');
      Meteor.call('fetchPatientChart', Session.get('oauthBaseUrl'), Session.get('accessToken'), Session.get('smartOnFhirIdentity'), Session.get('oauthService'), function (error, result) {
        if (error) {
  ...
  _proto.cacheObservations = function () {
...
module.exportDefault(FastImportPage);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"ImportChart.jsx":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/client/ImportChart.jsx                                                    //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");
...
var PatientSchema, Patients, PatientDstu2;
module.link("meteor/clinical:hl7-resource-patient", {
  PatientSchema: function (v) {
    PatientSchema = v;
  },
  Patients: function (v) {
    Patients = v;
  },
  PatientDstu2: function (v) {
    PatientDstu2 = v;
  }
}, 14);
var getUserIdResult = new ReactiveVar(null);
...
/*#__PURE__*/
function (_React$Component) {
  (0, _inheritsLoose2.default)(ImportChart, _React$Component);

  function ImportChart(props) {
    var _this;
  ...
  var _proto = ImportChart.prototype;
  ...
  _proto.getMeteorData = function () {
    function getMeteorData() {
      ...
      var resourceTypes = ['AllergyIntolerances', 'CarePlans', 'Conditions', 'Devices', 'DiagnosticReports', 'Goals', 'Immunizations', 'Medications', 'MedicationOrders', 'Organizations', 'Observations', 'Patients', 'Practitioners', 'Procedures'];
      resourceTypes.forEach(function (resourceType) {
        if (Mongo.Collection.get(resourceType)) {
          data.minimongo[resourceType] = Mongo.Collection.get(resourceType).find().count();
        }
      ...
      process.env.TRACE && console.log('ImportChart.data', data); // process.env.TRACE && console.log('ImportChart.props')
  ...
  _proto.render = function () {
    function render() {
      ...
      console.log('Patient Search URL: ', this.state.patientSearchUrl);
      console.log('Patient Fetch URL: ', this.state.baseUrl + '/Patient/' + this.state.patientId);
      return React.createElement("div", {
        id: "ImportChart"
      }, React.createElement(VerticalCanvas, null, React.createElement(Grid, null, React.createElement(Row, null, React.createElement(Col, {
        md: 3
        ...
        title: "Sign In With"
      }), React.createElement(CardText, null, signInWiths, React.createElement("hr", null), dataManagementButtons, React.createElement("hr", null), systemSyncButtons)), React.createElement(DynamicSpacer, null), React.createElement("h3", {
        className: "barcode",
        style: {
          width: '100%',
          textAlign: 'center',
        ...
        title: "1. Search Patients",
        subtitle: "Search includes proxy patients and dependents, such as children or parents." // subtitle={<span style={{color: 'rgb(38, 166, 154)'}}> { this.state.patientSearchUrl } </span>} 
        ...
        subtitle: "These are the patients that were returned from the health system..." // subtitle={<span style={{color: 'rgb(38, 166, 154)'}}> { this.state.baseUrl + '/Patient/' + this.state.patientId } </span>} />

      }), React.createElement(CardText, null, React.createElement(PatientTable, {
        ...
        patient: this.state.patient,
        zDepth: 2
      }), continuityOfCareCard, React.createElement(Row, null, React.createElement(Col, {
        md: 4
      }, React.createElement(GlassCard, null, React.createElement(RaisedButton, {
        label: "Healthcard",
        id: "healthCardBtn",
        onClick: this.healthCardBtn.bind(this),
        style: {
          textAlign: 'left'
        },
        primary: true,
        ...
        id: "continuityOfCareButton",
        onClick: this.continuityOfCareBtn.bind(this),
        style: {
          textAlign: 'left'
        },
        primary: true,
  ...
  _proto.continuityOfCareBtn = function () {
    function continuityOfCareBtn() {
      browserHistory.push('/continuity-of-care');
    }

    return continuityOfCareBtn;
  }();

  _proto.healthCardBtn = function () {
    function healthCardBtn() {
      browserHistory.push('/healthcard');
    }

    return healthCardBtn;
  }();
  ...
  _proto.fetchPatientData = function () {
    function fetchPatientData() {
      ...
      if (typeof this.state.patientId === "string") {
        fetchUrl = Session.get('oauthBaseUrl') + '/Patient/' + this.state.patientId + formatSuffix;
      } else if ((0, _typeof2.default)(this.state.patientId) === "object") {
        console.log('this.state.patientId', this.state.patientId); // fetchUrl = Session.get('oauthBaseUrl') + '/Patient/' + this.state.patientId + formatSuffix;
      }
      ...
      HTTP.get(fetchUrl, {
        ...
        if (result) {
          ...
          if (result.content) {
            patientData = JSON.parse(result.content);
            console.log('C13.4   Received patient data.', patientData); // create context

            console.log('PatientDstu2', PatientDstu2); // console.log('Quarantining and cleaning new patient...')
            // PatientDstu2.clean(patientData);
            // validate patientData

            var importationContext = PatientDstu2.newContext();
            importationContext.validate(patientData);
            console.log('Patient medical chart is valid according to the latest known schema: ', importationContext.isValid());

            if (!importationContext.isValid()) {
              console.log('Validation Errors:  ', importationContext.validationErrors());
            } // create patient
            ...
            if (patientData.id) {
              patientId = Session.get('oauthService') + "/" + patientData.id;
            } else {
              patientId = Random.id();
            }

            console.log('Attempting to create the following patient record: ' + patientId);

            var returnedPatientId = Patients._collection.upsert(patientId, {
              $set: patientData
            });

            console.log('Returned patient ID', returnedPatientId);
          }
  ...
  _proto.savePatientDemographicsToProfile = function () {
    function savePatientDemographicsToProfile() {
      ...
      if (confirm('Are you sure?  This can be dangerous and will overwrite your existing profile info.')) {
        console.log("Okay, then.  Attempting to update the user profile for user " + Meteor.userId());
  ...
  _proto.updateSearch = function () {
    function updateSearch(field, event, value) {
      ...
      newState.patientSearchUrl = Session.get('oauthBaseUrl') + '/Patient/_search?family=' + this.state.patientSearch.family + '&given=' + this.state.patientSearch.given + '&_format=application/json'; //console.log('updateSearch.newState', newState)
  ...
  _proto.searchPatients = function () {
    function searchPatients() {
      console.log('this.state.patientSearchUrl', this.state.patientSearchUrl); // var self = this;    
      // var patientId = 'Tbt3KuCY0B5PSrJvCu2j-PlK.aiHsu2xUjUM8bWpetXoB'
      // console.log('patientId', patientId)
      // var patientSearchUrl = Session.get('oauthBaseUrl') + '/Patient/_search?family=' + this.state.patientSearch.family + '&given=' + this.state.patientSearch.given + '&_format=application/json';
      // console.log('patientSearchUrl', patientSearchUrl)
  ...
  _proto.searchObservations = function () {
    function searchObservations() {
      ...
      HTTP.post(observationUrl, {
        ...
        if (result) {
          ...
          console.log('observationData', observationData);
          var newState = self.state; //newState.observationData = EJSON.stringify(observationData, {indent: 2});
  ...
  _proto.searchChart = function () {
    function searchChart() {
      var self = this;
      var patientId = this.state.patientId; // Allergies
        ...
        if (result) {
          ...
          if (bundle && bundle.entry) {
            bundle.entry.forEach(function (pointer) {
              ...
              if (pointer.fullUrl) {
                HTTP.get(pointer.fullUrl + '?_format=application/json', {
                  headers: {
                    'Authorization': 'Bearer ' + Session.get('accessToken')
                  }
                ...
                HTTP.get(pointer.fullUrl + '?_format=application/json', {
                  ...
                  if (redirectResult && redirectResult.content) {
                    ...
                    if (resource.resourceType === "Condition") {
                      if (!(Conditions._collection.find({
                        id: resource.id
                      }).count() > 0)) {
      ...
      HTTP.post(diagnosticResourceUrl, {
        headers: {
          'Authorization': 'Bearer ' + Session.get('accessToken')
        }
      }, function (err, result) {
        if (result) {
          var bundle = JSON.parse(result.content); // console.log('diagnosticResource.bundle', bundle)
...
module.exportDefault(ImportChart);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"OAuthClientPage.jsx":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/client/OAuthClientPage.jsx                                                //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");
...
module.export({
  OAuthClientPage: function () {
    return OAuthClientPage;
  }
});
var React;
module.link("react", {
...
/*#__PURE__*/
function (_React$Component) {
  (0, _inheritsLoose2.default)(OAuthClientPage, _React$Component);

  function OAuthClientPage(props) {
    var _this;
  ...
  var _proto = OAuthClientPage.prototype;
  ...
  _proto.render = function () {
    function render() {
      ...
      return React.createElement("div", {
        ...
        md: 4
      }, signInWiths))))), React.createElement(DynamicSpacer, null), React.createElement("div", {
        style: {
          paddingLeft: '40px'
        }
      ...
      }, this.state.accessToken)), React.createElement(CardActions, null, React.createElement(FlatButton, {
        label: "Fetch Access Token",
        id: "fetchAccessToken",
        onClick: this.fetchAccessToken.bind(this),
        primary: false
        ...
        }, " ", this.state.baseUrl + '/Patient/Tbt3KuCY0B5PSrJvCu2j-PlK.aiHsu2xUjUM8bWpetXoB', " ")
      }), "/>", React.createElement(CardText, null, React.createElement(Row, null, React.createElement(Col, {
        md: 12
      }, React.createElement("pre", {
        style: {
      ...
      }, this.state.patientData)))), React.createElement(CardActions, null, React.createElement(FlatButton, {
        label: "Fetch Patient Data",
        id: "fetchPatientData",
        onClick: this.fetchPatientData.bind(this),
        primary: false
        ...
        }, " ", this.state.baseUrl + '/Observation/', " ")
      }), "/>", React.createElement(CardText, null, React.createElement(ObservationsTable, {
      ...
      }, this.state.launchContext)), React.createElement(CardActions, null, React.createElement(FlatButton, {
        label: "Simulate Launch Context",
        id: "simulateLaunchContext",
        onClick: this.simulateLaunchContext.bind(this),
        primary: false
        ...
        }, " ", this.state.baseUrl + '/Patient/_search?given=Jason&family=Argonaut', " ")
      }), React.createElement(CardText, null, React.createElement(Grid, null, React.createElement(Row, null, React.createElement("br", null)), React.createElement(Row, null, React.createElement(Col, {
        md: 6
      }, React.createElement(TextField, {
        type: "text",
        ref: "name",
  ...
  _proto.autoscan = function () {
    function autoscan() {
      ...
      Meteor.call('metadataAutoscan', Session.get('oauthBaseUrl'), function (error, result) {
        if (result) {
          self.setState({
            metadata: EJSON.stringify(result, {
              indent: 2
            }),
            conformance: result
          });
...
module.exportDefault(OAuthClientPage);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}},"lib":{"methods.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/lib/methods.js                                                            //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var get;
...
var state = {
  ...
  metadata: '',
  baseUrl: 'https://open-ic.epic.com/Argonaut/api/FHIR/Argonaut',
  //TODO: remove and query ServiceConfiguration
  authorizeUrl: '',
  tokenUrl: '',
  patientSearch: {
    text: '',
...
Meteor.methods({
  placeBundleIntoCollections: function (bundle) {
    check(bundle, Object);
  ...
  fetchPatientFromEpic: function (accessToken) {
  ...
  fetchObservationsFromEpic: function (accessToken) {
  ...
  syncResourceFromEpic: function (accessToken, resourceType) {
  ...
  configureOauthService: function (formData, callback) {
    ...
    process.env.DEBUG && console.log('S11. Upserting ServiceConfiguration...'); // // https://atmospherejs.com/meteor/service-configuration
...
var getTokenResponse = function (query, config, autoscannedUrl) {
  ...
  var message = {
    params: params,
    // content: btoa('SymptomaticPHR2019:3B79E5D274954B7EA97C'),
    npmRequestOptions: {
      oauth: {
        body_hash: btoa('SymptomaticPHR2019:3B79E5D274954B7EA97C') // consumer_secret: '3B79E5D274954B7EA97C',
        // token_secret: '3B79E5D274954B7EA97C'

      }
    }
  };
  console.log('---------------------------------------------------------------');
  console.log('S10.3.1 Token Payload', message);
  console.log('---------------------------------------------------------------');
  httpResult = HTTP.post(oauthTokenUrl, message); // httpResult = HTTP.post(oauthTokenUrl, message, function(error, result){
  //     if(error){
  //         console.log('S10.3.error', error)
  //     }
  //     if(result){
  //         console.log('S10.3.result', result)
  //     }
  // });
...
var getIdentity = function (accessToken, config) {
  ...
  return HTTP.get(fetchUrl, {
    ...
    if (error) {// console.log('getIdentity().error', error)
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// packages/symptomatic_smart-on-fhir-client/index.jsx                                                                 //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.export({
...
var OAuthClientPage;
module.link("./client/OAuthClientPage", {
  "default": function (v) {
    OAuthClientPage = v;
  }
}, 0);
var ImportChart;
module.link("./client/ImportChart", {
  "default": function (v) {
    ImportChart = v;
  }
}, 1);
var FastImportPage;
module.link("./client/FastImportPage", {
  "default": function (v) {
    FastImportPage = v;
  }
}, 2);
var AdminConfigPage;
module.link("./client/AdminConfigPage", {
  "default": function (v) {
    AdminConfigPage = v;
  }
}, 3);
var OAuth;
module.link("./client/OAuth", {
  "default": function (v) {
    OAuth = v;
  }
}, 4);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/symptomatic_smart-on-fhir-client/node_modules/lodash/package.json                               //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/symptomatic_smart-on-fhir-client/node_modules/lodash/lodash.js                                  //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
/**
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/symptomatic_smart-on-fhir-client/node_modules/btoa/package.json                                 //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
module.exports = {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// node_modules/meteor/symptomatic_smart-on-fhir-client/node_modules/btoa/index.js                                     //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
(function () {
...
require("/node_modules/meteor/symptomatic:smart-on-fhir-client/client/OAuth.js");
require("/node_modules/meteor/symptomatic:smart-on-fhir-client/lib/methods.js");
var exports = require("/node_modules/meteor/symptomatic:smart-on-fhir-client/index.jsx");

/* Exports */
Package._define("symptomatic:smart-on-fhir-client", exports);
