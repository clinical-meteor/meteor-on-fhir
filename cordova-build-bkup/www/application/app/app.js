...
var Cache;
module.link("../../startup/client/cache.js", {
  Cache: function (v) {
    Cache = v;
  }
}, 25);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log('newUserData', newUserData); // if(validator.isEmail(newUserData.username)){
                ...
                return _regenerator.default.awrap(Accounts.createUser(newUserData, function (error, result) {
                  ...
                  if (result) {
                    ...
                    console.log("Accounts.createUser[Roles.userIsInRole(Meteor.userId()]", Roles.userIsInRole(Meteor.userId())); // Meteor.call('sendEnrollmentEmail', Meteor.userId());
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                     //
// imports/startup/client/cache.js                                                                                     //
//                                                                                                                     //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");
...
Cache = {
  deleteLocalData: function () {
    console.log('Confirming that we should delete local data.  Y/N?'); // if(confirm('Are you sure?')){
