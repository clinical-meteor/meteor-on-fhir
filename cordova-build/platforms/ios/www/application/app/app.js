  ...
  _proto.render = function () {
    function render() {
      ...
      if (get(Meteor, 'settings.public.defaults.sidebar.menuItems.GettingStarted')) {
        gettingStarted = React.createElement(LinkContainer, {
      ...
      if (get(Meteor, 'settings.public.defaults.sidebar.menuItems.DataManagement')) {
        if (!['iPhone'].includes(window.navigator.platform)) {
          dataManagement = React.createElement(LinkContainer, {
            key: "dataItem",
            to: "/data-management"
          }, React.createElement(MenuItem, {
            primaryText: "Data Management",
      ...
      if (get(Meteor, 'settings.public.defaults.sidebar.menuItems.FhirResources')) {
        if (!['iPhone'].includes(window.navigator.platform)) {
          fhirResources = React.createElement(LinkContainer, {
            key: "fhirItem",
            to: "/fhir-resources-index"
          }, React.createElement(MenuItem, {
            id: "fhirResourcePageItem",
      ...
      }, index, healthlog, continuityOfCareElements, spacer, fhirResources, dataManagement, React.createElement("hr", null), gettingStarted, smartOnFhirImports, React.createElement("hr", null), React.createElement(LinkContainer, {
        key: "themingItem",
        to: "/theming"
      }, React.createElement(MenuItem, {
        primaryText: "Theming",
...
function (_React$Component) {
  ...
  _proto.render = function () {
    function render() {
      ...
      }, index, registrationLinks, React.createElement("hr", null), publicElements, React.createElement("hr", null), React.createElement(IndexLinkContainer, {
        to: "/about"
      }, React.createElement(MenuItem, {
        primaryText: "About",
        href: "/about"
  ...
  _proto.render = function () {
    function render() {
      ...
      if (get(Meteor.user(), 'profile.consents.geocoding.status') === "active") {
        ...
        }), React.createElement(CardText, null, React.createElement(DynamicSpacer, null), React.createElement(TextField, {
      ...
      , {
        ...
        fullWidth: true
      }))))), React.createElement(DynamicSpacer, null), geocodingCard, continuityOfCareCard, React.createElement(DynamicSpacer, null), React.createElement(GlassCard, null, React.createElement(CardTitle, {
      ...
      }, this.renderConfirmDelete(this.data.state.wantsToDelete)))), React.createElement(DynamicSpacer, null), React.createElement(DynamicSpacer, null))));
    }
...
function (_React$Component) {
  ...
  _proto.render = function () {
    function render() {
      ...
      if (Meteor.userId() && (0, _typeof2.default)(PrivacyControlsCard) === "object") {
  ...
  _proto.render = function () {
    function render() {
      ...
      return React.createElement("div", {
        ...
        label: "Register",
        fullWidth: true
      }), React.createElement("br", null)))))), React.createElement("br", null), React.createElement("br", null)), signInWith)));
    }
