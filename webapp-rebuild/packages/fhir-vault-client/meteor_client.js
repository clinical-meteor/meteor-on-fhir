OAuth2.requestCredential = function (options, credentialRequestCompleteCallback) {
  ...
  var loginStyle = OAuth._loginStyle(OAuth2.serviceName, config, options);
  ...
  OAuth.launchLogin({
    loginService: OAuth2.serviceName,
